...
class PengajuanIjinResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'nip' => $this->nip,
            'nama' => $this->name,
            'ijin' => optional($this->ijin)->nama,
            'tanggal' => tanggal_indo($this->tanggal_mulai),
            'mulai' => get_jam($this->tanggal_mulai),
            'selesai' => get_jam($this->tanggal_selesai),
