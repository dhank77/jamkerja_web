...
<body>
    <div style="padding-top: -40px;">
                        ...
                        <span style="font-family: arial;">
                            @if ($perusahaan->logo != '')
                                <img style="float: left; margin-top:10px; margin-left:20px"
                                    src="{{ storage_path("app/public/" . $perusahaan->logo) }}" alt="" height="50" />
                            @endif
                        </span>
                    </td>
                    <td style="width: 400px; height:200px; text-align: center; border-style: hidden;" colspan="7">
                        <p> <strong>
                                <span
        ...
        <table>
            <tbody>
                <tr>
                    <td rowspan="10" style="width: 150px; vertical-align: top; border-style: hidden;"></td>
                    <td style="width: 100px; vertical-align: top; border-style: hidden;"><span
                            style="color: #000000; font-family: arial;">a.</span></td>
                    <td style="width: 300px; vertical-align: top; border-style: hidden;"><span
                            style="color: #000000; font-family: arial;">Nomor Pegawai</span></td>
                    <td style="width: 50px; vertical-align: top; border-style: hidden;"><span
                            style="color: #000000; font-family: arial;">:</span></td>
                    <td style="width: 300px; vertical-align: top; border-style: hidden;">{{ $pegawai->nip }}</td>
                    <td style="width: 22.0054%; vertical-align: top; border-style: hidden;" rowspan="7">
                        {!! $pegawai->image != null && file_exists('storage/' . $pegawai->image)
                            ? '<img style="float: right;" src="' .
                                storage_path("app/public/" . $pegawai->image) .
                                '" alt="" width="150" height="191" /></td>'
                            : '<img style="float: right;" src="' .
                                public_path("no-image.png") .
                                '" alt="" width="150" height="191" /></td>' !!}
                                <td rowspan="7"></td>
