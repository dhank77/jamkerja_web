...
<body>
    <table>
        ...
        <tr>
            ...
            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000"
                colspan=20 align="left" valign=top><b>
        ...
        <tr>
            <td colspan="8"></td>
            <td colspan="6" height="30" align="center" valign="bottom">
                <b>
                    <font face="Arial" size=1>JOMBANG , {{ strtoupper(tanggal_indo(date('Y-m-d'))) }}</font>
                </b>
            </td>
        </tr>
    </table>
    ...
    <table cellspacing="0" border="0" width="100%">
        ...
        <tr>
            ...
            <td colspan=3 align="left" valign=middle>
                <font color="#000000">{{ implode(',', $cuti['tanggal']) }}</font>
            </td>
        </tr>
        <tr>
            <td colspan=2 height="20" align="left" valign=middle>
