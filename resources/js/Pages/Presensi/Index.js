                                ...
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <img src={u.image_datang} alt="image" className="h-50 w-50 align-self-end" />
                                            </td>
                                            <td>
                                                <p>{u.jam_pulang}</p>
                                            </td>
                                            <td>
                                                <img src={u.image_pulang} alt="image" className="h-50 w-50 align-self-end" />
                                            </td>
                                            <td>
                                                <p>{u.jam_istirahat_mulai}</p>
                                            </td>
                                            <td>
                                                <p>{u.jam_istirahat_selesai}</p>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
