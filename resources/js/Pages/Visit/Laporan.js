                ...
                <div className="card mb-5 mb-xl-8">
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bolder fs-3 mb-1">Download Laporan Kunjungan</span>
                        </h3>
                    </div>
                    <div className="card-body py-3">
                        <form method='get' action={route("pengajuan.kunjungan.laporan_download")} target="_blank">
