                            ...
                            <div className="tab-content" id="myTabContent">
                                ...
                                <div className={`tab-pane fade ${key == 'data-riwayat' ? 'active show' : ''}`} id="data-riwayat" role="tabpanel">
                                    <ul className="nav flex-wrap border-transparent fw-bolder">
                                        ...
                                        <li className="nav-item my-1">
                                            <Link preserveScroll className={`btn btn-success btn-active-dark btn-active-color-secondary fw-boldest fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase ${route().current('pegawai.cuti*') ? 'active' : ''}`} href={route('pegawai.cuti.index', pegawai.nip)}><i class="fa fa-briefcase mr-1"></i> Riwayat Cuti</Link>
                                        </li>
                                        <li className="nav-item my-1">
                                            <Link preserveScroll className={`btn btn-success btn-active-dark btn-active-color-secondary fw-boldest fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase ${route().current('pegawai.pcuti*') ? 'active' : ''}`} href={route('pegawai.pcuti.index', pegawai.nip)}><i class="fa fa-chart-pie mr-1"></i> Potongan/Penambahan Cuti</Link>
                                        </li>
                                        {/* <li className="nav-item my-1">
                                ...
                                <div className={`tab-pane fade ${key == 'unduh-berkas' ? 'active show' : ''}`} id="unduh-berkas" role="tabpanel">
                                    <ul className="nav flex-wrap border-transparent fw-bolder">
                                        <li className="nav-item my-1">
                                            <a target='_blank' className={`btn btn-success btn-active-dark btn-active-color-secondary fw-boldest fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase`} href={route('pegawai.berkas.profile_pdf', pegawai.nip)}><i class="fa fa-file mr-1"></i> Unduh Profil PDF</a>
                                        </li>
                                        {/* <li className="nav-item my-1">
                            ...
                            <div className="card mb-5 mb-xl-10" id="kt_profile_details_view">
                                <div className="card-header cursor-pointer">
                                    ...
                                    <div className='d-flex align-items-center'>
                                        <ResetImei routes={route('pegawai.pegawai.reset_imei', pegawai.nip)} />
                                        <ResetPass routes={route('pegawai.pegawai.reset_pass', pegawai.nip)} />
                                        <Link href={route('pegawai.pegawai.edit', pegawai.nip)} className="btn btn-primary align-self-center mr-2"><b>Edit Data</b></Link>
                                    </div>
                                </div>
