...
export default function Approved({ errors, tugas }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        Inertia.post(route('pengajuan.tugas.update_selesai'), values);
    }
        ...
        <div className="card mb-5 mb-xl-8">
            <div className="card-header border-0 pt-5 flex">
                <h3 className="card-title align-items-start flex-column">
                    <span className="card-label fw-bolder fs-3 mb-1">Form Selesai Tugas</span>
                </h3>
            ...
            <div className="card-body py-3">
                <form onSubmit={submit}>
                    ...
                    <div className="row mb-6">
                        <label className="col-lg-3 col-form-label fw-bold fs-6 required">Unggah Hasil</label>
                        <div className="col-lg-9 fv-row fv-plugins-icon-container">
                            {
