...
import CancelWithComment from '@/Components/Crud/CancelWithComment'
                                ...
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <Dropdown>
                                                    <Logs model_type="App\Models\Pegawai\DataPengajuanCuti" model_id={u.id} />
                                                    {
                                                        u.kode_status == 0 ?
                                                            <>
                                                            ...
                                                            : u.kode_status == 1 ? <CancelWithComment routes={route('pengajuan.cuti.cancel', u.id)} /> : ""
                                                    }
                                                </Dropdown>
                                            </td>
                                        </tr>
