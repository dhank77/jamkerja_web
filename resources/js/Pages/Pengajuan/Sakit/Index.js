...
export default function Index({ sakit }) {

    const { data, meta } = sakit
            ...
            <div className="toolbar mb-5 mb-lg-7 d-flex justify-content-between">
                <div className="page-title d-flex flex-column me-3">
                    ...
                    <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                        ...
                        <li className="breadcrumb-item text-gray-600">sakit</li>
                    </ul>
                </div>
            </div>
                ...
                <div className="card mb-5 mb-xl-8">
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bolder fs-3 mb-1">Data Pengajuan sakit</span>
                        </h3>
                    </div>
                                ...
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <Dropdown>
                                                    <Logs model_type="App\Models\Pengajuan\PengajuanSakit" model_id={u.id} />
                                                    {
                                                        u.kode_status == 0 ?
                                                            <>
                                                                <Reject routes={route('pengajuan.sakit.reject', u.id)} />
                                                                <Approved routes={route('pengajuan.sakit.approved', u.id)} />
                                                            </>
                                                            : ""
                                                    }
                                                </Dropdown>
