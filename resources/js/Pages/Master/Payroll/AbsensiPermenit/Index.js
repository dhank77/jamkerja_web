...
export default function Index({ absensiPermenit }) {

    const { data, meta } = absensiPermenit
        ...
        <div>
            <div className="toolbar mb-5 mb-lg-7">
                ...
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.payroll.absensiPermenit.add')} className="btn btn-primary"><b>Tambah</b></Link>
                </div>
            </div>
                                ...
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <span className="text-dark fw-bolder text-hover-primary fs-6">{u.level}</span>
                                            </td>
                                            <td>
                                                <span className="text-dark fw-bolder text-hover-primary fs-6">{u.potongan}</span>
                                            </td>
                                            <td>
                                                <p>{u.keterangan}</p>
                                            </td>
