        ...
        <div>
            <div className="toolbar mb-5 mb-lg-7">
                ...
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.izin.add')} className="btn btn-primary"><b>Tambah</b></Link>
                </div>
            </div>
                                ...
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <Dropdown>
                                                    <Edit routes={route('master.izin.edit', u.id)} />
                                                    <Delete routes={route('master.izin.delete', u.id)} />
                                                </Dropdown>
                                            </td>
                                        </tr>
                                    ))}
