...
export default function Add({ errors, ijin }) {

    const [values, setValues] = useState({
        kode_ijin: ijin.kode_ijin,
        nama: ijin.nama,
        id: ijin.id,
    })
    ...
    const submit = (e) => {
        e.preventDefault();
        Inertia.post(route('master.ijin.store'), values);
    }
        ...
        <div>
             <div className="toolbar mb-5 mb-lg-7 d-flex justify-content-between">
                ...
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.ijin.index')} className="btn btn-dark"><b>Kembali</b></Link>
                </div>
            </div>
