...
export default function Add({ errors, kelompok, pegawai, pegawai_select }) {
    ...
    const [values, setValues] = useState({
        ...
        kode_perusahaan: kelompok.kode_perusahaan,
        nama: kelompok.nama,
        kordinat: kelompok.kordinat ?? "-4.008427, 119.622869",
        latitude: kelompok.latitude,
        longitude: kelompok.longitude,
        jarak: kelompok.jarak ?? 100,
        id: kelompok.id,
    })
    ...
    const submit = (e) => {
        e.preventDefault();
        Inertia.post(route('master.kelompok.store'), {data : values, pegawai: nipPegawai});
    }
            ...
            <div className="toolbar mb-5 mb-lg-7 d-flex justify-content-between">
                <div className="page-title d-flex flex-column me-3">
                    ...
                    <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                        ...
                        <li className="breadcrumb-item text-gray-600">Kelompok Presensi</li>
                        <li className="breadcrumb-item text-gray-500">Data</li>
                    </ul>
                </div>
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.kelompok.index')} className="btn btn-dark"><b>Kembali</b></Link>
                </div>
            </div>
            <div className="card mb-5 mb-xl-8">
                <div className="card-header border-0 pt-5 flex">
                    <h3 className="card-title align-items-start flex-column">
                        <span className="card-label fw-bolder fs-3 mb-1">Tambah Kelompok Presensi</span>
                    </h3>
                </div>
                <div className="card-body py-3">
                    <form onSubmit={submit}>
                        <div className="row mb-6">
                            <label className="col-lg-3 col-form-label required fw-bold fs-6">Nama Kelompok Presensi</label>
                        ...
                        <div className="row mb-6">
                            ...
                            <div className="col-lg-9 fv-row fv-plugins-icon-container">
                                <Select defaultValue={pegawai_select} isMulti className='z-50 w-full' onChange={changeSelect} options={pegawai} />
                            </div>
                            {errors.nama && <div className="text-danger">{errors.nama}</div>}
                        </div>
                        <div className="row mb-6">
                            <label className="form-label">Lokasi Kelompok Presensi</label>
                            <div>
